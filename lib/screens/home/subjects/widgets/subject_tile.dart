  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: subject.colorHex.withOpacity(0.1),
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 64,
            decoration: BoxDecoration(
              color: subject.colorHex.withOpacity(0.05),
              borderRadius: BorderRadius.circular(14),
            ),
            child: Image.asset(
              'assets/images/${subject.iconPath}',
              errorBuilder: (_, __, ___) =>
                  Icon(Icons.book_rounded, color: subject.colorHex, size: 32),
            ),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(subject.name, style: AppTextStyles.h4),
